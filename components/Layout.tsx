        ...
        >
          ...
          <div className="relative pt-6 pb-8 px-8">
             ...
             <div className="flex gap-4 mb-8 text-xs font-bold uppercase tracking-widest items-center">
                {/* WeChat Icon - Text '微' */}
                <button 
                  className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 hover:bg-[#07C160] hover:text-white transition-all duration-300 font-sans font-bold text-base"
                ...
                {/* XiaoHongShu Icon - Text '书' */}
                <a 
                   href="https://xhslink.com/m/4FrLqFlYhZj" 
                   target="_blank" 
                   rel="noopener noreferrer" 
                   className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 hover:bg-[#FF2442] hover:text-white transition-all duration-300 font-sans font-bold text-base"
                   title="XiaoHongShu"
                >
                    书
                </a>
